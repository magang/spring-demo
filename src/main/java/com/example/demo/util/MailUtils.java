...
public class MailUtils {
    ...
    public void sendMail(MailVo mailVo) {
        ...
        if (checkMail(mailVo)) {
            ...
            throw new CommonException("邮件地址异常");
        }
    }
     ...
     * 发送邮件真实操作
     */
    private void sendMailAct(MailVo mailVo) {
        ...
        try {
            ...
            // 设置邮件抄送人
            mimeMessageHelper.setCc(mailVo.getCc() == null ? new String[]{} : mailVo.getCc());
            // 设置邮件密送人
            mimeMessageHelper.setBcc(mailVo.getBcc() == null ? new String[]{} : mailVo.getBcc());
            // 设置邮件主题
